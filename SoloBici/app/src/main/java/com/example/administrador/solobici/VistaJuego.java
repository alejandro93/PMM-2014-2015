package com.example.administrador.solobici;
...
public class VistaJuego extends View {
    ...
    private int numCoches = 10;		//Numero inicial de Coches
    ...
    public VistaJuego(Context contexto, AttributeSet atributos) {
        ...
        bici.setIncX(Math.random() * 4 - 2);
        bici.setIncY(Math.random() * 4 - 2);
    ...
    protected synchronized void mover(){
